...
export default function Footer() {
  return <>
  <div className='container text-white bg-[#2c3e50] p-20 fixed grid justify-items-center items-center lg:grid-cols-12 bottom-0 right-0 left-0 mx-auto'>
    
    <div className="item-1 col-span-4">
